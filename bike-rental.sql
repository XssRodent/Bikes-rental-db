...
INSERT INTO public.rentals VALUES (1, 2, 1, '2024-09-01', '2024-09-01');
INSERT INTO public.rentals VALUES (2, 2, 2, '2024-09-01', '2024-09-01');
INSERT INTO public.rentals VALUES (3, 2, 3, '2024-09-01', '2024-09-01');
INSERT INTO public.rentals VALUES (4, 2, 4, '2024-09-01', '2024-09-01');
INSERT INTO public.rentals VALUES (5, 2, 5, '2024-09-01', '2024-09-01');
INSERT INTO public.rentals VALUES (8, 2, 1, '2024-09-01', '2024-09-01');
INSERT INTO public.rentals VALUES (6, 3, 6, '2024-09-01', '2024-09-01');
INSERT INTO public.rentals VALUES (7, 3, 7, '2024-09-01', '2024-09-01');
...
--
-- Name: rentals fkey_rentals_bikes; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.rentals
    ADD CONSTRAINT fkey_rentals_bikes FOREIGN KEY (bike_id) REFERENCES public.bikes(bike_id);


--
-- Name: rentals fkey_rentals_customers; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.rentals
    ADD CONSTRAINT fkey_rentals_customers FOREIGN KEY (customer_id) REFERENCES public.customers(customer_id);
